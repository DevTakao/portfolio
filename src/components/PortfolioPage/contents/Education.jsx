  ...
  return (
    <div className="text-left">
      <p className="pb-6">
        ...
        scores in <b className="font-semibold">English</b>(81/100), <b className="font-semibold">Maths</b>(98/100) and{" "}
        <b className="font-semibold">Physics</b>(92/100). Those marks probably mean nothing by now, I just wanted to
        show my foundations of critical thinking and Maths.
        <br />
      ...
      <ul className="list-disc px-6 pb-6">
        ...
        <li>JavaScript Data Structure & Algorithms</li>
      </ul>
      <p className="pb-6">
